  ...
  [
   ...
   // MCExt.me_call_a1.rawValue   : (call_a1,   .me_wait),
    ...
    0b010_1111  :  (jmp_k,     .me_wait),
        ...
        // Types P, I1, I2
    0b011_0000  :  (movsb_ar,  .me_load_sb),
    0b011_0001  :  (movw_ra,   .me_store_w),
    0b011_0010  :  (movb_ra,   .me_store_b),
    0b011_0011  :  (lea_qr,    .me_end),
    0b011_0100  :  (movw_qr,   .me_load_w),
    0b011_0101  :  (movsb_qr,  .me_load_sb),
    0b011_0110  :  (movw_rq,   .me_store_w),
    0b011_0111  :  (movb_rq,   .me_store_b),
    0b011_1000  :  (lea_mr,    .me_end),
    0b011_1001  :  (movw_mr,   .me_load_w),
    0b011_1010  :  (movzb_mr,  .me_load_zb),
    0b011_1011  :  (movsb_mr,  .me_load_sb),
    0b011_1100  :  (movw_rm,   .me_store_w),
    0b011_1101  :  (movb_rm,   .me_store_b),
    0b011_1110  :  (call_k,    .me_call_k1),
    0b011_1111  :  (_pfix,     .me_end),
    
    // Types I2, R2, R1, J (miscelaneous)
    0b100_0000  :  (set_cr,    .me_end),
    0b100_0001  :  (sel_crrr,  .me_end),
    0b100_0010  :  (br_ck,     .me_end),
    0b100_0011  :  (nop,       .me_end),
    0b100_0100  :  (nop,       .me_end),
    0b100_0101  :  (nop,       .me_end),
    0b100_0110  :  (nop,       .me_end),
    0b100_0111  :  (nop,       .me_end),
    0b100_1000  :  (nop,       .me_end),
    0b100_1001  :  (nop,       .me_end),
    0b100_1010  :  (mov_kr,    .me_end),
    0b100_1011  :  (cmp_rk,    .me_end),
    0b100_1100  :  (add_kr,    .me_end),
    0b100_1101  :  (sub_kr,    .me_end),
    0b100_1110  :  (and_kr,    .me_end),
    0b100_1111  :  (movw_ar,   .me_load_w),
...
//    if (!n0 && !d3) || !n1 || !a2 || !a3  { oh = 3 }   // Types J, R1, R2  with 0000ccc11x, 0001ccc, 010_0ccc,
