//===-- CPU74MCCodeEmitter.h - Convert CPU74 Code to Machine Code -------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the CPU74MCCodeEmitter class.
//
//===----------------------------------------------------------------------===//
//

#ifndef LLVM_CPU74_CODE_EMITTER_H
#define LLVM_CPU74_CODE_EMITTER_H

//#include "CPU74FixupKinds.h"
...
/// Writes CPU74 machine code to a stream.
class CPU74MCCodeEmitter : public MCCodeEmitter {
public:
  CPU74MCCodeEmitter(const MCInstrInfo &MCII, MCContext &Ctx)
      : MCII(MCII), Ctx(Ctx) {}
...
//  template <CPU74::Fixups Fixup, unsigned Offset>
...
//                            const MCSubtargetInfo &STI) const;
  ...
  unsigned encodeSrcMemIndexed(const MCInst &MI, unsigned OpNo,
  ...
  CPU74MCCodeEmitter(const CPU74MCCodeEmitter &) = delete;
  void operator=(const CPU74MCCodeEmitter &) = delete;
...
#endif // LLVM_CPU74_CODE_EMITTER_H
